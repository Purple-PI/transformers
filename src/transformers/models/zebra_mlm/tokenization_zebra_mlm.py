...
class ZebraMlmTokenizer(PreTrainedTokenizer):
    """
    Construct a ZebraMLM tokenizer. Based on byte-level Byte-Pair-Encoding.
    ...
    def build_inputs_with_special_tokens(
        ...
        A ZebraMLM sequence has the following format:
